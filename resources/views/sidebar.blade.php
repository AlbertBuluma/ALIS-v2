...
<!-- 								<li>
 ...
 -->
							...
							<ul>
								<li>
									<div><a href="{{ route('user.dashboard')}}">
										<span class="glyphicon glyphicon-tag"></span>
										Dashboard</a>
									</div>
								</li>
					...
					<div class="sub_panel" style="left: -220px;">
						<div class="side_inner ps-ready ps-container" style="height: 620px;">
							...
							<ul>
								...
								<li>
									<div>
										<a href="{{ route('unhls_test.completed') }}">
											<span class="glyphicon glyphicon-tag" ></span>{{trans('Completed Tests')}}
																...
																<li>
									<div>
										<a href="{{ route('unhls_test.notrecieved') }}">
											<span class="glyphicon glyphicon-tag" ></span>{{trans('Samples Not Recieved')}}
																...
																<li>
									<div>
										<a href="{{ route('unhls_test.pending') }}">
											<span class="glyphicon glyphicon-tag" ></span>{{trans('Pending Tests')}}
																...
																<li>
									<div>
										<a href="{{ route('unhls_test.started') }}">
								...
								<li>
									<div>
										<a href="{{ route('unhls_test.verified') }}">
			...
			@can('manage_users')
				...
				<li class="nav_trigger">
					...
					<li>
						<div>
                            @if(Illuminate\Support\Facades\Auth::user()->can('manage_users'))
                                <a href="{{ route('user.index') }}">
                            @else
                                <a href="{{ URL::to('user/'.Illuminate\Support\Facades\Auth::user()->id.'/edit') }}">
                            @endif
							<a href="{{ Illuminate\Support\Facades\Auth::user()->can('manage_users') ? route('user.index') : URL::to('user/'.Illuminate\Support\Facades\Auth::user()->id.'/edit') }}">
			...
			@endcan
				...
				<li class="nav_trigger">
					<a href="#">
						...
						<span class="nav_title">Other Resources</span>
					</a>
					<div class="sub_panel" style="left: -220px;">
						<div class="side_inner ps-ready ps-container" style="height: 620px;">
							...
							<a href="http://vldash.cphluganda.org/" target="_blank">
								<span class=""></span>  Load Dashboard</a>
							</li>
							<li>
