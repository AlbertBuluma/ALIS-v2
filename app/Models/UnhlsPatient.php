...
class UnhlsPatient extends Model
{
    ...
    {
        return $this->hasMany('App\Models\UnhlsVisit', 'patient_id');
    }
    /**
     * Visits relationship
     */
    ...
    {
        return $this->hasOne('App\Models\MicroPatientDetail', 'patient_id');
    }
    ...
    {
        return $this->hasMany('App\Models\PatientAntibiotics', 'patient_id');
    }
